...
def same_radius_avg(nano_original_concentration, r, xy_index, radius_list, relations, a_arr, b_arr, c_arr, nods):
    ...
    for q in range(len(r_xy_index)):
        ...
        x = r_xy_index[q][0] - 300
        y = r_xy_index[q][1] - 300
        # 根据xy在纳米空间中插值计算该点的值
...
def process_concentration(nano_original_concentration, open_original_concentration, c_val, position_list_i, grids_rz,
                          xy_index,
